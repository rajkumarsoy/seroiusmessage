...
<link rel="stylesheet" href="<?php  echo base_url('theme/css/matrix-style.css'); ?>" />
<link rel="stylesheet" href="<?php  echo base_url('theme/css/matrix-media.css'); ?>" />
<link href="<?php  echo base_url('theme/font-awesome/css/font-awesome.css'); ?>" rel="stylesheet" />
<link rel="stylesheet" href="<?php  echo base_url('theme/css/jquery.gritter.css'); ?>" />
...
<script src="<?php  echo base_url('theme/js/excanvas.min.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.min.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.ui.custom.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/bootstrap.min.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.flot.min.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.flot.resize.min.js'); ?>"></script> 
...
<script src="<?php  echo base_url('theme/js/matrix.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/matrix.dashboard.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.gritter.min.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/matrix.interface.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/matrix.chat.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.validate.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/matrix.form_validation.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.wizard.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.uniform.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/select2.min.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/matrix.popover.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/jquery.dataTables.min.js'); ?>"></script> 
<script src="<?php  echo base_url('theme/js/matrix.tables.js'); ?>"></script> 
